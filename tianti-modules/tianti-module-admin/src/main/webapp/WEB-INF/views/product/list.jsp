		                             ...
		                             <tr>
		                                 ...
		                                 <td>
		                                     <div class="t_link">
												 <c:choose>
													 <c:when test="${c.auditFlag eq '2' }">
														 <a href="javascript:myLook('${c.id }');"><i class="icon"></i>详情</a>
													 </c:when>
													 <c:when test="${c.auditFlag eq '1' }">
														 <a href="javascript:myLook('${c.id }');"><i class="icon"></i>详情</a>
													 </c:when>
...
<script type="text/javascript">
	function myAdd(){
        window.location.href="${ctx}/product/toEdit";
	}
	function myAudit(id){
		var loadIdx = layer.load();
		var title = '产品审核';

		$.post('${ctx}/product/details?id='+id, {}, function(str){
    ...
    function myLook(id){
        ...
        $.post('${ctx}${ctx}/com/details?id='+id, {}, function(str){
