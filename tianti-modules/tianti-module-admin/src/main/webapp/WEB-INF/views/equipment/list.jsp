		...
		<form action="${ctx }/user/list" id="queryForm" method="post">
			<div class="J_toolsBar clearfix">
				...
				<div class="t_label ml10">
					设备总数：<label style="color: red;" id="total">${page.totalCount }</label>
				</div>
			</div>
...
<script type="text/javascript">
    function myAdd(){
        //跳转到新增
        window.location.href="${ctx}/equipment/toEdit";
    }
    function myLook(id){
        var loadIdx = layer.load();
        var title = '查看设备信息';

        $.post('${ctx}/equipment/details?id='+id, {}, function(str){
    ...
    function toEdit(id){
        ...
        $.post('${ctx}/equipment/toEdit?id='+id, {}, function(str){
            layer.close(loadIdx);
