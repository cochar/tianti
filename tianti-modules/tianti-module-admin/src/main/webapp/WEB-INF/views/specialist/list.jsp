	        ...
	        <div class="J_toolsBar clearfix">
				...
				<div class="t_button ml10">
               	...
               	<div class="t_label ml10">
					专家总数：<label style="color: red;" id="total">${page.totalCount }</label>
				</div>
			</div>
...
<script type="text/javascript">
    function myAdd(){
        //跳转到新增
        window.location.href="${ctx}/specialist/toEdit";
    }
    function myLook(id){
        var loadIdx = layer.load();
        var title = '查看专家信息';

        $.post('${ctx}/specialist/details?id='+id, {}, function(str){
    ...
    function toEdit(id){
        ...
        $.post('${ctx}/specialist/toEdit?id='+id, {}, function(str){
