	...
	<div class="mt20 plr20">
		<form action="${ctx }/user/list" id="queryForm" method="post">
			<div class="J_toolsBar clearfix">
				<div class="t_label">企业分类名称</div>
				<div class="t_text ml10">
					<input placeholder="企业分类名称..." type="text" name="name" id="name" value="${specialist.name }"/>
				</div>
				...
				<div class="t_label ml10">
					维度信息总数：<label style="color: red;" id="total">${page.totalCount }</label>
				</div>
			</div>
...
<script type="text/javascript">
    function myAdd(){
        //跳转到新增
        window.location.href="${ctx}/companyType/toEdit";
    }
    function myLook(id){
        var loadIdx = layer.load();
        var title = '查看企业维度信息';

        $.post('${ctx}/companyType/details?id='+id, {}, function(str){
    ...
    function toEdit(id){
        ...
        $.post('${ctx}/companyType/toEdit?id='+id, {}, function(str){
